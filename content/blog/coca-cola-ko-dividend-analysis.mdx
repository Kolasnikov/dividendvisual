...
These two moats are why KO's cash flows are so predictable, and why management has been able to confidently raise the dividend every year for six decades. Compare this with sector peers [PepsiCo](/analysis/pep), [Procter & Gamble](/analysis/pg), or [Colgate-Palmolive](/analysis/cl) — all Kings or Aristocrats built on similar structural advantages.
...
[See KO's live Weiss chart on DividendVisual →](/analysis/ko)
...
*Track KO's live yield position against its 10-year Weiss bands on DividendVisual. [View the KO analysis →](/analysis/ko)*
