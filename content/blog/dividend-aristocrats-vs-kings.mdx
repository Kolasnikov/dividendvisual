...
**Dividend Aristocrats** have a broader sector footprint. You'll find healthcare companies (Abbott, Medtronic), technology-adjacent names (Texas Instruments, Automatic Data Processing), REITs (Federal Realty), energy companies (Chevron, ExxonMobil), and a wider range of industrials. This breadth makes the Aristocrats index more correlated with the overall S&P 500 — which is both a feature (better diversification) and a limitation (lower defensiveness in genuine drawdowns).
